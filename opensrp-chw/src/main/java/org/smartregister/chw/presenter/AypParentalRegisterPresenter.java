...
public class AypParentalRegisterPresenter extends BaseAypRegisterFragmentPresenter {

    public AypParentalRegisterPresenter(AypRegisterFragmentContract.View view,
                                        AypRegisterFragmentContract.Model model,
