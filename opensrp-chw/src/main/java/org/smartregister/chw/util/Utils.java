...
public class Utils extends org.smartregister.chw.core.utils.Utils {
    ...
    public static void reprocessIndependentClientRegistrationEvents(String familyBaseEntityId, String baseEntityId) {

        reprocessIndependentClientEventType(
                familyBaseEntityId,
    ...
    private static void reprocessIndependentClientEventType(String baseEntityId, String eventType, String entityType) {
        try {
    ...
    public static void reprocessIndependentClientEvents(
