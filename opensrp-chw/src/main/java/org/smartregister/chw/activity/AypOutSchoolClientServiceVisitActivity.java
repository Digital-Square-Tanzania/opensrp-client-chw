...
public class AypOutSchoolClientServiceVisitActivity extends BaseAypOutSchoolRecordServiceVisitActivity {
    ...
    protected void registerPresenter() {
        presenter = new BaseAypVisitPresenter(memberObject, this, new BaseAypOutSchoolClientVisitInteractor());
    }
