...
import org.smartregister.chw.interactor.AypOutSchoolGroupMedicalHistoryInteractor;
...
public class AypOutSchoolGroupMedicalHistoryActivity extends CoreAncMedicalHistoryActivity {
    private static AypInSchoolGroupListItem aypGroupObject;
    private final Flavor flavor = new AypOutSchoolMedicalHistoryActivityFlv();
    private ProgressBar progressBar;

    public static void startMe(Activity activity, AypInSchoolGroupListItem groupObject) {
        Intent intent = new Intent(activity, AypOutSchoolGroupMedicalHistoryActivity.class);
        aypGroupObject = groupObject;
        activity.startActivity(intent);
    }

    @Override
    public void initializePresenter() {
        presenter = new BaseAncMedicalHistoryPresenter(new AypOutSchoolGroupMedicalHistoryInteractor(), this, aypGroupObject.getBaseEntityId());
    }
    ...
    public void setUpView() {
        ...
        tvTitle.setText(getString(org.smartregister.chw.opensrp_chw_anc.R.string.back_to, aypGroupObject.getGroupName()));
        ...
        public void processViewData(List<Visit> visits, Context context) {
            ...
            if (visits.size() > 0) {
                ...
                while (x < visits.size()) {
                    ...
                    String[] visitTypeAypParams = {"member_names","provided_sbc_service", "choose_sbc_service_provided","choose_economic_empowerment_services","next_appointment_date"};
                ...
                for (LinkedHashMap<String, String> vals : community_visits) {
                    ...
                    tvEdit.setOnClickListener(view1 -> {
                        ...
                        if (visit.getBaseEntityId() != null) {
                            ...
                            AypOutSchoolGroupVisitActivity.startAypOutSchoolGroupVisitActivity((Activity) context, true, aypGroupObject.getBaseEntityId(),aypGroupObject.getGroupName());
                        }
                    });

                    String visitType;

                    if (AYP_OUT_SCHOOL_GROUP_FOLLOW_UP_VISIT.equals(visits.get(x).getVisitType())) {
