...
public class AypParentalMedicalHistoryInteractor extends BaseAncMedicalHistoryInteractor {
    ...
    public void getMemberHistory(final String memberID, final Context context, final BaseAncMedicalHistoryContract.InteractorCallBack callBack) {
        final Runnable runnable = () -> {
            ...
            try {
                ...
                if (library == null) {
                    Timber.w("AypLibrary instance not initialised when loading parental medical history");
                } else {
                    ...
                    appendVisits(visits, visitRepository.getVisits(memberID, Constants.EVENT_TYPE.AYP_PARENTAL_SERVICES), detailsRepository);
                }
            } catch (Exception e) {
                Timber.e(e);
            }
