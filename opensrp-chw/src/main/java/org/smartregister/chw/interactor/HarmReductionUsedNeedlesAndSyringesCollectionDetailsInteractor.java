...
public class HarmReductionUsedNeedlesAndSyringesCollectionDetailsInteractor extends CoreBaseAncMedicalHistoryInteractor {
    ...
    public void getMemberHistory(final String memberID, final Context context, final BaseAncMedicalHistoryContract.InteractorCallBack callBack) {
        final Runnable runnable = () -> {
            String[] eventTypes = new String[]{HARM_REDUCTION_USED_NEEDLES_AND_SYRINGES_COLLECTION};
