...
import org.smartregister.chw.model.HpsHouseholdProfileMemberModel;
...
public class HpsHouseholdProfileMemberFragment extends CoreFamilyProfileMemberFragment {


    public static BaseFamilyProfileMemberFragment newInstance(Bundle bundle) {
        Bundle args = bundle;
        BaseFamilyProfileMemberFragment fragment = new HpsHouseholdProfileMemberFragment();
        if (args == null) {
            args = new Bundle();
        }
    ...
    protected void initializePresenter() {
        ...
        presenter = new FamilyProfileMemberPresenter(this, new HpsHouseholdProfileMemberModel(), null, familyBaseEntityId, familyHead, primaryCareGiver);
    }
