...
import org.smartregister.chw.adapter.HpsAdvertisementFeedbackRegisterAdapter;
...
import org.smartregister.chw.model.HpsAdvertisementFeedbackRegisterFragmentModel;
import org.smartregister.chw.presenter.HpsAdvertisementFeedbackRegisterFragmentPresenter;
...
public class HpsAdvertisementFeedbackRegisterFragment extends BaseHpsRegisterFragment {
    ...
    private HpsAdvertisementFeedbackRegisterAdapter adapter;
    ...
    protected void initializePresenter() {
        ...
        presenter = new HpsAdvertisementFeedbackRegisterFragmentPresenter(this, new HpsAdvertisementFeedbackRegisterFragmentModel(), viewConfigurationIdentifier);
    }
    ...
    protected void setUpAdapter() {
        List<HpsAdvertisementFeedbackModel> hpsAdvertisementFeedbackModels = HpsDao.getHpsAdvertisementFeedback();
        if (hpsAdvertisementFeedbackModels != null && !hpsAdvertisementFeedbackModels.isEmpty()) {
            adapter = new HpsAdvertisementFeedbackRegisterAdapter(hpsAdvertisementFeedbackModels, requireActivity());
    ...
    protected void refreshSyncProgressSpinner() {
        ...
        if (syncButton != null) {
            ...
            syncButton.setOnClickListener(view -> {
                JSONObject form;
                try {
                    form = (new FormUtils()).getFormJsonFromRepositoryOrAssets(requireActivity(), Constants.FORMS.HPS_ADVERTISEMENT_FEEDBACK);
                    if (form != null) {
