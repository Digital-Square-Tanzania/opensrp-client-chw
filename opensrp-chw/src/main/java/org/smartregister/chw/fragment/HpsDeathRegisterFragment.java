...
import org.smartregister.chw.adapter.HpsDeathRegisterAdapter;
...
import org.smartregister.chw.presenter.HpsDeathRegisterFragmentPresenter;
...
public class HpsDeathRegisterFragment extends BaseHpsRegisterFragment {
    ...
    private HpsDeathRegisterAdapter adapter;
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            titleView.setText(getString(R.string.hps_death_register_title));
    ...
    protected void initializePresenter() {
        ...
        presenter = new HpsDeathRegisterFragmentPresenter(this, new HpsDeathRegisterFragmentModel(), viewConfigurationIdentifier);
    }
    ...
    protected void setUpAdapter() {
        List<HpsDeathRegisterModel> cecapMobilizationSessionModels = HpsDao.getHpsDeathRegisterRecords();
        if (cecapMobilizationSessionModels != null && !cecapMobilizationSessionModels.isEmpty()) {
            adapter = new HpsDeathRegisterAdapter(cecapMobilizationSessionModels, requireActivity());
    ...
    protected void refreshSyncProgressSpinner() {
        ...
        if (syncButton != null) {
            ...
            syncButton.setOnClickListener(view -> {
                JSONObject form;
                try {
                    form = (new FormUtils()).getFormJsonFromRepositoryOrAssets(requireActivity(), Constants.FORMS.HPS_DEATH_REGISTRATION);
                    if (form != null) {
