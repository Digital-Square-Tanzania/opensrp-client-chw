...
import org.smartregister.chw.adapter.HpsMobilizationSessionsRegisterAdapter;
...
import org.smartregister.chw.model.HpsMobilizationSessionRegisterFragmentModel;
import org.smartregister.chw.presenter.HpsMobilizationRegisterFragmentPresenter;
...
public class HpsMobilizationRegisterFragment extends BaseHpsRegisterFragment {
    ...
    private HpsMobilizationSessionsRegisterAdapter adapter;
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            titleView.setText(getString(R.string.hps_mobilization_sessions_title));
    ...
    protected void initializePresenter() {
        ...
        presenter = new HpsMobilizationRegisterFragmentPresenter(this, new HpsMobilizationSessionRegisterFragmentModel(), viewConfigurationIdentifier);
    }
    ...
    protected void setUpAdapter() {
        List<HpsMobilizationSessionModel> hpsMobilizationSessionModels = HpsDao.getHpsMobilizationSessions();
        if (hpsMobilizationSessionModels != null && !hpsMobilizationSessionModels.isEmpty()) {
            adapter = new HpsMobilizationSessionsRegisterAdapter(hpsMobilizationSessionModels, requireActivity());
    ...
    protected void refreshSyncProgressSpinner() {
        ...
        if (syncButton != null) {
            ...
            syncButton.setOnClickListener(view -> {
                JSONObject form;
                try {
                    form = (new FormUtils()).getFormJsonFromRepositoryOrAssets(requireActivity(), Constants.FORMS.HPS_MOBILIZATION);
                    if (form != null) {
                        String randomId = generateRandomUUIDString();
                        form.put(ENTITY_ID, randomId);
                        requireActivity().startActivityForResult(getStartEditFormIntent(form, requireActivity().getString(R.string.hps_mobilization_sessions_title), requireActivity()), JsonFormUtils.REQUEST_CODE_GET_JSON);
                    }
