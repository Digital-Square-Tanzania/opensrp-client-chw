...
import org.smartregister.chw.repository.DelegatingRepository;
...
public class ChwApplication extends CoreChwApplication {
    ...
    private void initializeLibraries() {
        ...
        ReportingLibrary.init(context,
                new DelegatingRepository(getApplicationContext(), context.session(), this::getRepository),
                null, BuildConfig.VERSION_CODE, BuildConfig.DATABASE_VERSION);
        ...
        MotherMentorLibrary.init(context, getRepository(), BuildConfig.VERSION_CODE, BuildConfig.DATABASE_VERSION);
    ...
    public Map<String, Class> getRegisteredActivities() {
        ...
        registeredActivities.put(CoreConstants.REGISTERED_ACTIVITIES.MOTHER_MENTOR_REGISTER_ACTIVITY, MotherMentorRegisterActivity.class);
