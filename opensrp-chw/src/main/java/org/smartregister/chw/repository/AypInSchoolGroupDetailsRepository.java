 ...
 */
public class AypInSchoolGroupDetailsRepository extends BaseRepository {

    public static final String TABLE_NAME = "ec_ayp_in_school_group_details";
    ...
    public AypInSchoolGroupDetailsRepository() {
        ensureTableExists();
    }
    ...
    public long save(AypInSchoolGroupDetails record) {
        try {
            ...
            Timber.e(e, "Error saving AypInSchoolGroupCreation");
            return -1;
        }
    }
    ...
    public void saveAll(List<AypInSchoolGroupDetails> records) {
        ...
        try {
            ...
            Timber.e(e, "Error bulk saving AypInSchoolGroupCreation");
        } finally {
            db.endTransaction();
        }
    }
